...
namespace TheLast
{
    ...
    public partial class App
    {
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            containerRegistry.RegisterForNavigation<RemoteControl, RemoteControlViewModel>();
            ...
            containerRegistry.RegisterDialog<RealTimeCurve, RealTimeCurveViewModel>();
            containerRegistry.RegisterDialog<Realtime, RealtimeViewModel>();
            containerRegistry.RegisterForNavigation<SkinView, SkinViewModel>();
            containerRegistry.RegisterForNavigation<LoginView, LoginViewModel>();
            containerRegistry.RegisterDialog<HistoricalCurve, HistoricalCurveViewModel>();
        }
